...
const {
    ...
    googleAuth, googleCallback, getMe
...
router.put('/client-profile', protect, require('../controller/authController').updateClientProfileMe);
router.post('/forgot-password', forgotPassword);
router.post('/reset-password/:token', resetPassword);
router.post('/logout', logout);
router.get('/group-members', protect, getGroupMembers);
router.post('/switch-client', protect, switchClient);
router.get('/my-ca', protect, require('../controller/authController').getMyCA);
