...
//     // 1. Get Client counts by category for this CA
//     const stats = {
//         GST: await prisma.client.count({
//             where: {
//                 caId: caId,
//                 isActive: true,
//                 gstNumber: { not: null },
...
//     // 3. Get Recent Clients (last 10) for the main table
...
//     // 1. Get Recent Folders (last 15) for this specific client
//     const recentFolders = await prisma.folder.findMany({
//         where: {
//             clientId: clientId,
//             isDeleted: false,
...
//                 uploadedBy: (uploadedBy === 'CLIENT' ? 'CUSTOMER' : uploadedBy) || 'CUSTOMER',
...
exports.getDashboardStats = catchAsync(async (req, res) => {
    ...
    // 2. Get Recent Folders opened by this CA user only.
